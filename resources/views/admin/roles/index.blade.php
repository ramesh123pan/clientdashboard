	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">All Roles
				<b>Role Management</b>
				@can('role-create')
				<a class="btn btn-success btn-sm float-right" href="{{ route('roles.create') }}"><i class="fa fa-plus"></i> Create New Role</a>
				@endcan
			</div>
			<div class="card-body">
				@include('my-flash')
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								@endcan
								@can('role-delete')
								{!! Form::open(['method' => 'DELETE','route' => ['roles.destroy', $role->id],'style'=>'display:inline','onsubmit' => 'return confirm("Do you want to delete this role?")'] ) !!}
